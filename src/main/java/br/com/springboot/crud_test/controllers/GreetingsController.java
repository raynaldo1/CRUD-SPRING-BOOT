...
public class GreetingsController {
    ...
    @ResponseBody
    public ResponseEntity<List<UserClass>> searchByName (@RequestParam(name = "name") String name) {
        List<UserClass> users = userRepository.searchByName(name.trim().toUpperCase());
